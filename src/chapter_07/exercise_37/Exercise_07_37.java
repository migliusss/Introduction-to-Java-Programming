package chapter_07.exercise_37;
 ...
 *
 * Write a program that stimulates the bean machine. Your program should prompt the
 * user to enter the number of balls and the number of the slots in the machine.
 * Stimulate the falling of each balls by printing its path. For example, the path for
 ...
 *
 * (Hint: Create an array names slots. Each element in slots stores the number of
